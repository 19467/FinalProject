...
public class FirstPersonAIO : MonoBehaviour {
    ...
    private void Start(){
        ...
        #region Music - Start
        gameObject.GetComponent<soundSystem>().PlayMusic();
        #endregion
    ...
    private void Update(){
        ...
        if (sceneName == "level2gameplay" && !ran)
        {
            GameObject.Find("FirstPerson-AIO").transform.position = GameObject.Find("PositionHolder").transform.position;
            staminaInternal = staminaLevel;
            ran = true;
        }
